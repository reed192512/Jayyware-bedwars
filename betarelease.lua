local jayywareFolder = Instance.new("Folder",workspace)
jayywareFolder.Name = "jayywareFolder"
local joinEvents = {}
local connections = {}
local joinEvent = Instance.new("BindableEvent",jayywareFolder)
joinEvent.Name = "joinEvent"
local plrSpawn = Instance.new("BindableEvent",jayywareFolder)
...
if not betterShared(shared.Jayy_wareLoaded) then
	...
	shared.JayyWareFullyLoaded = false
	...
	local libraries = {Whitelist = "https://raw.githubusercontent.com/reed192512/Jayyware-bedwars/main/WhitelistLibrary.lua"}
	...
	runfunc(function()
		...
		TextLabel243.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		TextLabel243.BackgroundTransparency = 1
		TextLabel243.Text = "Jayy-Ware"
		TextLabel243.Name = "Jayy-Ware"
		TextLabel243.TextScaled = true
		TextLabel243.TextSize = 28.000
		TextLabel243.TextWrapped = true
		TextLabel243.TextColor3 = theme
	...
	for i,v in pairs(game.Players.LocalPlayer.PlayerGui:GetDescendants()) do
		runfunc(function()
			...
			until not betterShared(shared.Jayy_wareLoaded)
		end)
	end
	game.Players.LocalPlayer.PlayerGui.DescendantAdded:Connect(function(v)
		if betterShared(shared.Jayy_wareLoaded) then
			pcall(function()
	...
	Notify("Jayy-Ware "..name_string.." Loaded",5)
	...
	runfunc(function()
		...
		killSay = {"You got destroyed by Jayy-Ware","Jayy-Ware on top","Looks like you forgot Jayy-Ware","L","Ouch (rekt by Jayy-Ware)"}
		deathSay = {"I was lagging | Jayy-Ware on top","Bad, you just got lucky | Jayy-Ware","L legits"}
		local tagged = {}
	...
	shared.JayyWareFullyLoaded = true
